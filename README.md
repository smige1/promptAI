...
tailwind yes
src/directory no
experimental app direct yes
import alais @/*

npm install bcrypt mongodb mongoose nextauth

bcrypt is use to hash passwords
mongodb for database
mongoose to manage mongodb

component are use for reusabale component folder/files
models is use for our mongodb mongoose database models
